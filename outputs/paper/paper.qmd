...
### City-Wide Annual Circulation and Visits
Tables that provide a summary of the city-wide total visits (@tbl-tplannualvisits) and total circulation (@tbl-tplannualcirculation) for each year. Annual circulation and visitation metrics have high standard deviations of 5,502,796 and 6,349,144, respectively. The high standard deviations imply that the overall annual variance of these metrics is high, therefore indicating values are spread out from the mean. This is seen in the graphs for both usage metrics as 2020 and 2021 reveal significantly smaller values compared to 2018 and 2019. By viewing the annual data, it is clear that the graphs represent the annual data after comparing the table to the aforementioned sections. 
